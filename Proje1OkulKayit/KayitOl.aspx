                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html" class="drop-text">Resimler</a></li>
                                </ul>
                            </li>
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Şimdi Kayıt Olun</h3>
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        <label class="col-form-label">Kullanıcı Adı</label>
                          <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="Kullanıcı Adınız ..."></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Email</label>
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="mail@gmail.com"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehriniz</label>
                        <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" placeholder="Şehriniz..."></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Parola</label>
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="*******" TextMode="Password"></asp:TextBox>
                    </div>
                    <div class="sub-w3l my-3">
                        <div class="sub-w3layouts_hub">
                            ...
                            <label for="brand1" class="text-li text-style-w3ls">
                                <span></span>Kuralları okudum ve kabul ediyorum!</label>
                        </div>
                    </div>
